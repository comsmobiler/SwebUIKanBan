...
namespace SwebApplication5
{
    ...
    partial class RMQAbsoluteLayout : Swebui.Controls.SwebUserControl
    {
        ...
        private void RMQAbsoluteLayout_Load(object sender, EventArgs e)
        {
  ...
  textStyle:{
    ...
    color:['#1e74eb','#05eeff','#a778ff']
            ...
            #region"更新界面参数"
            label6.Text= Convert.ToDouble((random.Next(0, 9999) * 0.01)).ToString()+"%";
            label7.Text = Convert.ToDouble((random.Next(0, 99) * 0.1)).ToString()+"%";
            label8.Text = Convert.ToDouble((random.Next(0, 99) * 0.1)).ToString()+"%";
            label9.Text = Convert.ToDouble((random.Next(0, 9) * 0.1)).ToString()+"%";
            #endregion
        }
        ...
        private void imagePanel_V_C2_Load(object sender, EventArgs e)
        {
